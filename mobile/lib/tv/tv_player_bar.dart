                    ...
                    builder: (_, __) {
                      ...
                      return IconButton(
                        icon: Icon(
                            ...
                            color: isFav ? kAccent : kTextSecond,
                            size: 18),
                        onPressed: () => favoritesService.toggle(song.id),
                      );
                    },
                  ),
                  IconButton(
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            IconButton(
                icon: Icon(Icons.shuffle,
                    color: player.shuffle ? kAccent : kTextSecond, size: 18),
                onPressed: player.toggleShuffle),
            IconButton(
                icon: const Icon(Icons.skip_previous,
                    color: kTextPrimary, size: 28),
            ...
            IconButton(
                icon:
                    const Icon(Icons.skip_next, color: kTextPrimary, size: 28),
            ...
            IconButton(
              icon: Icon(
                  player.repeat == LoopMode.one
                      ? Icons.repeat_one
                      : Icons.repeat,
                  color: player.repeat != LoopMode.off ? kAccent : kTextSecond,
                  size: 18),
