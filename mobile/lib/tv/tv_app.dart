...
class _TvAppState extends State<TvApp> {
  ...
  ThemeData _tvTheme() => ThemeData(
        ...
        fontFamily: 'Roboto',
        focusColor: kAccent.withValues(alpha: 0.3),
        textTheme: const TextTheme(
          headlineLarge: TextStyle(
              color: kTextPrimary, fontSize: 32, fontWeight: FontWeight.w900),
  ...
  Future<void> _login() async {
    ...
    try {
      final data = await Api.post(
          '/auth/login', {'email': _email.text, 'password': _pass.text});
              ...
              if (_error.isNotEmpty) ...[
                ...
                Text(_error,
                    style: const TextStyle(
                        color: Color(0xFFE8115B), fontSize: 14)),
              ],
