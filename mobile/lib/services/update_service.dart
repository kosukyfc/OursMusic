...
class UpdateService {
  ...
  static Future<void> checkForUpdate(BuildContext context,
    ...
    try {
      final res = await http
          .get(Uri.parse('$kApiBase/app/version'))
  ...
  static Future<void> _startGracePeriod(String version) async {
    ...
    if (existing != version) {
      ...
      await prefs.setString(
          _kGracePeriodStart, DateTime.now().toIso8601String());
    }
  }
  ...
  static Future<bool> _isGracePeriodExpired(String version) async {
    ...
    if (gracePeriodVersion != version) {
      return false; // Grace period não iniciado
    }
    ...
    try {
      ...
      if (result.type != ResultType.done && mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content:
              Text('Não foi possível abrir o instalador: ${result.message}'),
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(
          notes.replaceAll('\\n', '\n'),
          style: const TextStyle(
              color: Color(0xFFB3B3B3), fontSize: 13, height: 1.7),
        ),
        ...
        if (forceUpdate) ...[
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: const Color(0xFFF15E6C).withValues(alpha: 0.4)),
            ),
            child: const Row(children: [
              ...
              Expanded(
                ...
                style: TextStyle(
                    color: Color(0xFFF15E6C), fontSize: 13, height: 1.4),
              )),
            ]),
          ),
        ] else ...[
          ...
          const Text(
            ...
            style:
                TextStyle(color: Color(0xFFB3B3B3), fontSize: 13, height: 1.5),
          ...
          Container(
            ...
            child: const Row(children: [
              ...
              Expanded(
                ...
                style: TextStyle(
                    color: Color(0xFF1DB954), fontSize: 13, height: 1.4),
              )),
            ]),
          ),
        ],
