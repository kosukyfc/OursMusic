...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _editAvatar() {
    showModalBottomSheet(
      ...
      builder: (_) => AvatarEditSheet(
        ...
        onSaved: (url) =>
            setState(() => _profile = {...?_profile, 'avatarUrl': url}),
      ),
    );
  }

  bool get _isPremium =>
      _profile?['plan'] == 'premium' || _profile?['plan'] == 'family';
              ...
              SliverToBoxAdapter(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Row(children: [
                        _Stat(
                            count: _profile?['followersCount'] ?? 0,
                            label: 'seguidores'),
                        const SizedBox(width: 24),
                        _Stat(
                            count: _profile?['followingCount'] ?? 0,
                            label: 'seguindo'),
                      ]),
                      ...
                      _MenuItem(
                          ...
                          label: 'Tema',
                          subtitle: themeService.current.name,
                          onTap: () => _showThemeSheet()),
                      _MenuItem(
                          icon: Icons.language,
                          label: 'Idioma',
                          subtitle: _langName(themeService.lang),
                          onTap: () => _showLangSheet()),
                      _MenuItem(
                          icon: Icons.music_note_outlined,
                          label: 'Qualidade de audio',
                          subtitle: 'Alta',
                          onTap: () => _showAudioSheet()),
                      _MenuItem(
                          icon: Icons.download_outlined,
                          label: 'Downloads',
                          subtitle: _isPremium ? 'Ativado' : 'Apenas premium',
  ...
  void _showNotifSheet() {
    showModalBottomSheet(
      ...
      shape: const RoundedRectangleBorder(
          borderRadius: BorderRadius.vertical(top: Radius.circular(16))),
      builder: (_) => const _ToggleSheet(title: 'Notificacoes', items: [
  ...
  void _showPrivacySheet() {
    showModalBottomSheet(
      ...
      shape: const RoundedRectangleBorder(
          borderRadius: BorderRadius.vertical(top: Radius.circular(16))),
      builder: (_) => const _ToggleSheet(title: 'Privacidade', items: [
  ...
  void _showAudioSheet() {
    showModalBottomSheet(
      ...
      builder: (_) => const _RadioSheet(
          title: 'Qualidade de audio',
          options: ['Automatica', 'Baixa', 'Normal', 'Alta', 'Muito alta'],
          selected: 'Alta'),
    );
  }
                  ...
                  child: Column(children: [
                    AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color:
                              selected ? theme.accent : const Color(0xFF3A3A3A),
                          width: selected ? 3 : 1,
                        ),
                        boxShadow: selected
                            ? [
                ...
                title: Text(lang['name']!,
                    style: TextStyle(
                        ...
                        fontWeight:
                            selected ? FontWeight.w700 : FontWeight.w400)),
                trailing:
                    selected ? const Icon(Icons.check, color: kAccent) : null,
                onTap: () async {
...
class _MenuItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ListTile(
        ...
        title: Text(label,
            style: TextStyle(color: color ?? kTextPrimary, fontSize: 15)),
        subtitle: subtitle != null
            ? Text(subtitle!,
                style: const TextStyle(color: kTextMuted, fontSize: 12))
            : null,
        trailing: onTap != null && color == null
          ...
          child: Row(children: [
            ...
            const Expanded(
                child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                  Text('Atualizar para o Premium',
                      style: TextStyle(
                          color: kTextPrimary,
                          fontSize: 15,
                          fontWeight: FontWeight.w800)),
                  SizedBox(height: 2),
                  Text('Downloads, qualidade alta e sem anuncios',
...
class _PlanSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SafeArea(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const Text('OursMusic Premium',
              style: TextStyle(
                  color: kTextPrimary,
                  fontSize: 22,
                  fontWeight: FontWeight.w900)),
          const SizedBox(height: 8),
          const Text('Aproveite ao maximo sua musica',
          ...
          const SizedBox(height: 20),
          const Text(
              'Solicite ao administrador para ativar o Premium na sua conta.',
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(widget.title,
              style: const TextStyle(
                  ...
                  fontWeight: FontWeight.w800)),
          const SizedBox(height: 8),
          ...widget.options.map((opt) => RadioGroup<String>(
                ...
                child: RadioListTile<String>(
                  ...
                  fillColor: WidgetStateProperty.resolveWith((s) =>
                      s.contains(WidgetState.selected) ? kAccent : kTextMuted),
                ),
              )),
        ]),
      ));
        ...
        child: Column(
            ...
            children: [
              ...
              ...[
                [
                  'Como baixar musicas?',
                  'Usuarios premium podem baixar tocando no icone de download em qualquer musica.'
                ],
                [
                  'Como funciona o Premium?',
                  'O Premium e concedido pelo administrador. Inclui downloads, qualidade alta e modo offline.'
                ],
                [
                  'Nao consigo ouvir uma musica',
                  'Verifique sua conexao. Se o problema persistir, contate o suporte.'
                ],
                [
                  'Como mudar minha foto?',
                  'Toque no seu avatar na tela de perfil para alterar a foto.'
                ],
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(item[1],
                            style: const TextStyle(
                                color: kTextSecond, fontSize: 13, height: 1.5)),
                      )
                    ],
                  )),
            ]),
              ...
              ? Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  const Text('Obrigado pelo feedback!',
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.w800)),
                  const SizedBox(height: 8),
                  const Text('Seu relatorio foi enviado.',
                      style: TextStyle(color: kTextSecond, fontSize: 14)),
                  const SizedBox(height: 16),
                ])
              : Column(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        const Text('OursMusic',
            style: TextStyle(
                ...
                fontWeight: FontWeight.w900)),
        const SizedBox(height: 4),
        const Text('Versao $appVersion',
            style: TextStyle(color: kTextSecond, fontSize: 13)),
        const SizedBox(height: 16),
        const Text(
            'Sua musica, do seu jeito.\nStreaming de alta qualidade para todos.',
            style: TextStyle(color: kTextSecond, fontSize: 14, height: 1.5),
            textAlign: TextAlign.center),
        const SizedBox(height: 20),
